...
int gnetwork::ConnectingSocket::conn2serv(int sock, const struct sockaddr_in &address) {
...
int gnetwork::ConnectingSocket::bind2self(int sock, const struct sockaddr_in &address) {
